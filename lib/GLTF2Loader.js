...
module.exports = THREE.GLTF2Loader = ( function () {
	...
	GLTF2Loader.prototype = {
		...
		setPathTransform: function ( transform ) {

			this.pathTransform = transform;
		...
		parse: function ( data, callback, path ) {
			...
			var parser = new GLTFParser( json, extensions, {
				...
				path: path || this.path,
				pathTransform: this.pathTransform,
		...
		return this._withDependencies( [
			...
			return _each( json.shaders, function ( shader ) {
				...
				return new Promise( function ( resolve ) {
					...
					loader.load( self.resolveURL( shader.uri, options.path ), function ( shaderText ) {
	...
	GLTFParser.prototype.resolveURL = function ( url, path ) {
		...
		// Transform URL
		if ( this.options.pathTransform !== undefined ) {

			return this.options.pathTransform( url, path );
		...
		return _each( json.buffers, function ( buffer, name ) {
			...
			if ( buffer.type === 'arraybuffer' || buffer.type === undefined ) {
				...
				return new Promise( function ( resolve ) {
					...
					var loader = new THREE.FileLoader();
					loader.setResponseType( 'arraybuffer' );
					loader.load( self.resolveURL( buffer.uri, options.path ), function ( buffer ) {
			...
			return _each( json.textures, function ( texture ) {
				...
				if ( texture.source !== undefined ) {
					...
					return new Promise( function ( resolve ) {
						...
						textureLoader.load( self.resolveURL( sourceUri, options.path ), function ( _texture ) {
